...
class Cards(object):
    """
    一副扑克牌类,45张排,abcd四种花色
    """
    def __init__(self):
        #初始化扑克牌类型
        self.cards_type = ['A-a-11', 'A-b-11','A-c-11',
                           '2-a-12', '2-b-12','2-c-12',
                           '3-a-13', '3-b-13','3-c-13',
                           '4-a-1', '4-b-1','4-c-1','4-d-1',
                           '5-a-2', '5-b-2','5-c-2','5-d-2',
                           '6-a-3', '6-b-3','6-c-3','6-d-3',
                           '7-a-4', '7-b-4','7-c-4','7-d-4',
                           '8-a-5', '8-b-5','8-c-5','8-d-5',
                           '9-a-6', '9-b-6','9-c-6','9-d-6',
                           '10-a-7', '10-b-7','10-c-7','10-d-7',
                           'J-a-8', 'J-b-8','J-c-8','J-d-8',
                           'Q-a-9', 'Q-b-9','Q-c-9','Q-d-9',
                           'K-a-10', 'K-b-10','K-c-10','K-d-10',
                           ]
        #初始化扑克牌类                  
...
class PlayRecords(object):
    ...
    def show(self, info):
        ...
        card_show(self.cards_left3, "玩家", 1)
...
#        self.san_dai_er = []
    ...
    def get_moves(self, cards_left):
        ...
        for i in cards_left:
            ...
            #顺序
            if i.rank in [11,12,13]: #不统计1,2,3
                continue
...
#                    
    ...
    def get_next_moves(self, last_move_type, last_move): 
        ...
        if last_move_type == "start":
            moves_types = ["dan", "dui", "san", "shunzi"]
            i = 0
            for move_type in [self.dan, self.dui, self.san, self.shunzi]:
